...
figure(1)
plot(v_values(47,:),gamma_tot); hold on
plot(v_values(48,:),gamma_tot); hold on
plot(v_values(95,:),gamma_tot); hold on
plot(v_values(96,:),gamma_tot); hold on
plot(v_values(143,:),gamma_tot); hold on
plot(v_values(144,:),gamma_tot); hold on
