...
figure(1)
plot(v_values(11,:),gamma_tot); hold on
plot(v_values(12,:),gamma_tot); hold on
plot(v_values(23,:),gamma_tot); hold on
plot(v_values(24,:),gamma_tot); hold on
plot(v_values(35,:),gamma_tot); hold on
plot(v_values(36,:),gamma_tot); hold on
